...
Quaternion calculator implemented in C++.  
This program reads from a given text file providing two quaternions and a scalar value with spaces in between the quaternion parts and empty lines to separate the three items.  
...
.vs/Quaternion Calculator/v17/.suo is included for ease of solution loadup purposes since the solution has been manually configured. The solution should start with x64 Release, on main.cpp and Quaternion.txt in side by side docks.  
